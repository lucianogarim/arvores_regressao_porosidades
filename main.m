%% Algoritmo de Árvores de Regressão desenvolvido para o Projeto Sapinhoá %%
% ---------------------------Versão Inicial--------------------------------%
% Luciano Garim 23/08/22
clear;
clc;
...
% Função principal
arvore_treinada = regressao(dados, poda, kfold, desenhar_arvore, salvar_arvore, validacao_cruzada);
...
% Contando o número de valores de regressão (nós da árvore)
